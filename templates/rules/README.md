...
When you place rules in `.claude/rules/`, they are automatically discovered by the orchestration system and injected into the context for all agents working in your project.
